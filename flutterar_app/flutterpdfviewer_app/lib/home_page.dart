            ...
            IndexedStack(
              ...
              children: <Widget>[
                Column(children: <Widget>[
                  ...
                  PDF.asset(
                    "assets/demo.pdf", height: MediaQuery
                      .of(context)
                      .size
                      .height,
                    width: MediaQuery
                    ...
                    placeHolder: Image.asset(
                        "assets/images/pdf.png", height: 200,
                        width: 100),
                  )
                ]),
                Column(
                ...
                localFile != null
                  ...
                  onTap: () async {
                    ...
                    setState(() {
                      localFile = File(file.paths.first);
                    });
                  },
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          "Select PDF from device",textAlign: TextAlign.
                          center,
                          style: TextStyle(
      ...
      bottomNavigationBar: BottomNavigationBar(
          ...
          items: <BottomNavigationBarItem>[
            ...
            BottomNavigationBarItem(
                ...
                icon: Icon(Icons.book,
                    color: selectedIndex == 1 ? Colors.blue : Colors.grey)),
            BottomNavigationBarItem(title: Text("Device", style: TextStyle(
