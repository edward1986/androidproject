...
class _FilePickerDemoState extends State<FilePickerDemo> {
  ...
  void _openFileExplorer() async {
    ...
    setState(() {
      ...
      _fileName = _paths != null ? _paths.map((e) => _filePath.add("" + e.path)).toString() : '...';
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          ElevatedButton(
                            onPressed: () async {
                              var request = http.MultipartRequest('POST', Uri.parse("http://10.0.2.2:8000/api/users"));
                            ...
                            child: const Text("Directory Path"),
                          ),
                        ],
                      ),
                    ),
