...
public class CompareSensorActivity extends AppCompatActivity implements SensorEventListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public class WeatherAsyncTask extends AsyncTask<Object, Void, String> {
        ...
        String doInBackground(Object... params) {
            ...
            String urlparams = mUrlString + "lat=" + 100 + "&lon=" +100 + "&units=metric&APPID=" + AppId;
            try {
