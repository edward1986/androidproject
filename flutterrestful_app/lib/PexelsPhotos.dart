          ...
          Expanded(
            child: FutureBuilder<Response>(
              ...
              builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
                ...
                final List<Photo> photos = photosDynamic.map<Photo>((
                    dynamic p) {
                ...
                // And convert the List<Photo>s to a List<Widget>s to LogicalKeyboardKey.displayToggleIntExtfinal List<Widget> wid

                final List<Widget> widgets = photos.map<Widget>((Photo p) =>
                    Container(
  ...
  Future<Response> fetchPhotos() {
    ...
    final Future<Response> response = get(
      ...
      headers: <String, String>{
        ...
        'Authorization': "563492ad6f917000010000011a1d7cc60ba041f288144d3d9903a76d",
      },
    );
    return response;
  }
