...
public class MainActivity extends AppCompatActivity {
    ...
    private void uploadImagesToServer() {
        if (InternetConnection.checkConnection(MainActivity.this)) {
            ...
            RequestBody description = createPartFromString(etDescription.getText().toString());
            ...
            call.enqueue(new Callback<ResponseBody>() {
                @Override
                public
                void onResponse(@NonNull Call<ResponseBody> call, @NonNull Response<ResponseBody> response) {
                    hideProgress();
